                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  ...
                                  return otherUserProfileFuture.when(
                                    data: (otherUser) {
                                      ...
                                      if((otherUser!.userId) == chat.lastMessage!.senderID) {
                                      ...
                                      if(chat.lastMessage != null) {
                                        if(isLastMessageByCurrentUser != true ) {
                                          isLastMessageRead = chat.lastMessage!.isRead;
                                        }
                                                    ...
                                                    children: [
                                                      ...
                                                      Flexible(
                                                        child: Container(
                                                          ...
                                                          child:
                                                          Text(
                                                            (isLastMessageByCurrentUser ? 'You: ' : '') + chat.lastMessage!.text,
                                                            style: TextStyle(
                                                              color: Colors.black,
                                                              letterSpacing: 1,
                                                              fontSize: 14,
